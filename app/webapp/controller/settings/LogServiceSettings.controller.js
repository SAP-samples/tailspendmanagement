sap.ui.define([
	...
	"use strict";
	return BaseController.extend("com.sap.tailspend.controller.settings.LogServiceSettings", {
		formatter: formatter,
		...
		onInit: function () {
			...
			var oViewModel = new JSONModel({
					currentNumber: nNextNo
							});

			this.setModel(oViewModel, "LogNumber");
			oViewModel.refresh();
			// this.getView().byId("servicenumber").setValue(nNextNo);
